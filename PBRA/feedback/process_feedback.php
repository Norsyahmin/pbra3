...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Add current timestamp for the submitted_at column
    $currentTime = date('Y-m-d H:i:s');
    
    $stmt = $conn->prepare("INSERT INTO feedback (user_id, category, message, rating, attachment, submitted_at) VALUES (?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("isssss", $userId, $category, $message, $rating, $filePath, $currentTime);
