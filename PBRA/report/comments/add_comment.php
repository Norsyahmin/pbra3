...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$error && $comment) {
        $stmt = $conn->prepare('INSERT INTO report_comments (report_id, user_id, comment, attachment_path, created_at) VALUES (?, ?, ?, ?, NOW())');
        $stmt->bind_param('iiss', $report_id, $user_id, $comment, $file_path);
        if ($stmt->execute()) {
